...
$query_ptype = "SELECT * FROM menu_type";
...
mysql_select_db($database_condb, $condb);
$query_eprd = sprintf("SELECT * FROM menu WHERE m_id = %s", GetSQLValueString($colname_eprd, "int"));
...
<script src="//cdn.ckeditor.com/4.6.2/standard/ckeditor.js"></script>
  ...
  <div class="row">
      ...
      <div class="col-md-10">
        <h3 align="center">
        <a href="food_list.php" class="btn btn-default"> < ย้อนกลับ</a>
        ข้อมูลสินค้า
        	<?php // include('edit-ok.php');?>
        </h3>
        
        		<form action="food_form_edit_db.php"  method="post" enctype="multipart/form-data" name="Add_Product" id="Add_Product" >
