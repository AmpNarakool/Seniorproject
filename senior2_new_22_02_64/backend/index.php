...
<body class="w3-light-grey">
    ...
    <nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
        ...
        <div class="w3-bar-block">
            <a href="index.php" class="w3-bar-item w3-button w3-padding w3-green "><i
                    class="fa fa-clipboard-list"></i> คำสั่งซื้อทั้งหมด </a>
            <a href="sale.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-chart-line"></i>  ยอดขาย </a>
            <a href="food_type.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-calendar-plus"></i> 
                เพิ่มประเภทเมนู</a>
            <a href="food.php" class="w3-bar-item w3-button w3-padding"><i class="fas fa-book-medical"></i> 
                เพิ่มเมนู</a>
            <a href="payment.php" class="w3-bar-item w3-button w3-padding "><i class="fa fa-cash-register"></i> 
                การเงิน</a>
            <a href="course.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-list-alt"></i>  คอร์สอาหาร</a>
            <a href="member.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-user-edit"></i> 
                รายชื่อสมาชิก</a>
            <a href="emp.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-users"></i>  รายชื่อพนักงาน</a>

            <a href="../logout.php" onclick="return confirm('ย้นยันการออกจากระบบ');"
                class="w3-bar-item w3-button w3-padding"><i class="fa fa-sign-out-alt"></i>  ออกจากระบบ</a>
        </div>
    </nav>
    ...
    <div class="w3-main" style="margin-left:300px;margin-top:43px;">
        <div class="container">
            <div class="row">
              ...
              }elseif($act=='show-detail-course'){
                include('detail_course_afterdone.php');
