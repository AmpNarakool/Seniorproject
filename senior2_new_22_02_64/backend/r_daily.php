...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <?php
            $query = "
            SELECT pay_amount, SUM(pay_amount) AS totol, DATE_FORMAT(order_date, '%d-%M-%Y') AS order_date
            FROM orders
		   ...
		   $sql = "
            ...
            ";
            $result2 = mysql_db_query($database_condb, $sql);
