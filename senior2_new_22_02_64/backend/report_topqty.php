...
GROUP BY o.p_id ORDER BY  p_c_qty DESC LIMIT 5 
";
...
$p_c_qty = implode(",", $p_c_qty);

?>
<h3 align="center">รายงานสินค้าขายดีเรียงตามลำดับตามจำนวนที่ขายได้ 5 อันดับ</h3>
<table width="400" border="1" cellpadding="0"  cellspacing="0" align="center">
    ...
    <tr>
        ...
        <td align="right"><?php echo number_format($row['p_c_qty'],2);?></td>
    </tr>
...
<p align="center">
    ...
    datasets: [{
    label: 'รายงานสินค้าขายดี(QTY)',
    data: [<?php echo $p_c_qty;?>
    ],
    backgroundColor: [
    'rgba(255, 99, 132, 0.2)',
    'rgba(54, 162, 235, 0.2)',
