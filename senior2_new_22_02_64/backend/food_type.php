...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="food_type.php" class="w3-bar-item w3-button w3-padding w3-green"><i class="fa fa-calendar-plus"></i>  เพิ่มประเภทเมนู</a>  
...
<div class="main">
  <header class="w3-container" style="padding-top:22px">
    <h5><b><i class="fa fa-bell"></i> ข้อมูลประเภทอาหาร</b> <a href="food_type.php?act=add" class="btn-info btn-sm">+ เพิ่มข้อมูล +</a></h5>
  </header>
          ...
          <div class="col-xs-12">
            <div class="box">
              ...
              <?php
                  $act = $_GET['act'];
                  if($act == 'add'){
                  include('food_type_form_add.php');
                  }elseif ($act == 'edit') {
                  include('food_type_form_edit.php');
                  }else {
                  include('food_type_list.php');
                  }
                  ?>
                </div>
              </div>
