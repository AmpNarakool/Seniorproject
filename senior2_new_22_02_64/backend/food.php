...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="food.php" class="w3-bar-item w3-button w3-padding w3-green"><i class="fa fa-book-medical"></i>  เพิ่มเมนู</a>
...
<div class="main">
  <header class="w3-container" style="padding-top:22px">
    <h5><b><i class="fa fa-bell"></i> ข้อมูลรายการอาหาร</b> <a href="food.php?act=add" class="btn-info btn-sm">+ เพิ่มข้อมูล +</a></h5>
  </header>
